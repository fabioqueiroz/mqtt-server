...
namespace MQTT.CentralServer.WorkerService.Services
{
    public class MqttJobService : IHostedService, IMqttJobService
    {
        ...
        public MqttJobService(ILogger<MqttJobService> logger, IJobFactory jobFactory, IEnumerable<JobSchedule> jobSchedules)
        {
            _logger = logger;
        ...
        //        { "quartz.jobStore.dataSource", "default" },
        //        { "quartz.dataSource.default.provider", "SqlServer" },
        //        { "quartz.dataSource.default.connectionString", "Data Source=ZAISO-5079\\SQLEXPRESS;Initial Catalog=Quartz;Integrated Security=False;User Id=sa;Password=Fabio1980;" },
